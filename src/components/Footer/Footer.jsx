...
const Footer = () => {
    ...
    return (
        <footer className="relative bg-black text-quinary mt-auto">
            <div className="absolute top-0 left-0 w-[100%] overflow-hidden border-t-2 border-quinary my-8">
                <div className="grid lg:grid-cols-4 gap-20 md:grid-cols-2 px-20 py-10">
                    ...
                    <div>
                        ...
                        <li className="text-tertiary my-4 list-none">Title A</li>
                        <li className="text-tertiary my-4 list-none">Title B</li>
                        <li className="text-tertiary my-4 list-none">Title C</li>
                    </div>
                    ...
                    <div className="mb-4 md:mb-0">
                        ...
                        <p className="text-[16px] text-tertiary my-4">Email: nguyentuan20042207@gmail.com </p>
                        <p className="text-[16px] text-tertiary my-4">Phone: +84 564043602</p>
